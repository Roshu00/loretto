      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="relative h-[400px] lg:h-[500px] rounded-xl overflow-hidden shadow-xl border border-[#EBE5C2]">
            <div className="absolute inset-0 bg-gradient-to-br from-[#B9B28A] to-[#504B38] flex items-center justify-center">
              <div className="text-center text-white p-8">
                ...
                <p className="text-sm opacity-75 mb-4">{content.location.fullAddress}</p>
                <p className="text-xs opacity-60">
                  (Zameniti sa Google Maps embed kodom)
                </p>
              </div>
            </div>
          </div>
